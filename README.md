...
<h4 style="color:white; background-color:black; padding:10px; border-radius:10px;">Tools & Platforms</h4>
...
<h4 style="color:white; background-color:black; padding:10px; border-radius:10px;">Libraries / Frameworks</h4>
